  ...
  return (
    <div
      ...
      className={`
        ...
        group hover:border-white/15 hover:shadow-[0_20px_50px_rgba(0,0,0,0.8)]
      ...
      <div className="relative z-10 flex flex-row items-center justify-between p-4 border-b border-white/[0.05]">
        ...
        <div className="flex items-center gap-1.5 ml-3">
          ...
          <button
            {...attributes}
            {...listeners}
            className="p-1.5 rounded-lg bg-white/[0.05] border border-white/[0.08] hover:bg-white/[0.1] hover:border-white/[0.15] cursor-grab active:cursor-grabbing transition-all duration-500"
          >
